...
public class SavedSearch implements TBase {
  ...
  public int compareTo(Object otherObject) {
    ...
    SavedSearch other = (SavedSearch)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetFormat(), other.isSetFormat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFormat()) {
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("SavedSearch(");
    boolean first = true;
