...
public class Data implements TBase {
  ...
  public int compareTo(Object otherObject) {
    ...
    lastComparison = TBaseHelper.compareTo(isSetBodyHash(), other.isSetBodyHash());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBodyHash()) {
      lastComparison = TBaseHelper.compareTo(this.bodyHash, other.bodyHash);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = TBaseHelper.compareTo(isSetBody(), other.isSetBody());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBody()) {
