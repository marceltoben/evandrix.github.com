          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.tagGuids = new Vector(_list8.size);
              for (int _i9 = 0; _i9 < _list8.size; ++_i9)
              {
                String _elem10;
                _elem10 = iprot.readString();
                this.tagGuids.addElement(_elem10);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.resources = new Vector(_list11.size);
              for (int _i12 = 0; _i12 < _list11.size; ++_i12)
              {
                Resource _elem13;
                _elem13 = new Resource();
                _elem13.read(iprot);
                this.resources.addElement(_elem13);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.tagNames = new Vector(_list14.size);
              for (int _i15 = 0; _i15 < _list14.size; ++_i15)
              {
                String _elem16;
                _elem16 = iprot.readString();
                this.tagNames.addElement(_elem16);
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.tagGuids != null) {
      if (isSetTagGuids()) {
        oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter17_enum = this.tagGuids.elements(); _iter17_enum.hasMoreElements(); )           {
    ...
    if (this.resources != null) {
      if (isSetResources()) {
        oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
        {
          ...
          for (Enumeration _iter18_enum = this.resources.elements(); _iter18_enum.hasMoreElements(); )           {
            Resource _iter18 = (Resource)_iter18_enum.nextElement();
            _iter18.write(oprot);
          }
          oprot.writeListEnd();
        }
    ...
    if (this.tagNames != null) {
      if (isSetTagNames()) {
        oprot.writeFieldBegin(TAG_NAMES_FIELD_DESC);
        {
          ...
          for (Enumeration _iter19_enum = this.tagNames.elements(); _iter19_enum.hasMoreElements(); )           {
            String _iter19 = (String)_iter19_enum.nextElement();
