 ...
 */
public class PremiumOrderStatus implements org.apache.thrift.TEnum {

  public static final PremiumOrderStatus NONE = new PremiumOrderStatus(0);
  public static final PremiumOrderStatus PENDING = new PremiumOrderStatus(1);
  public static final PremiumOrderStatus ACTIVE = new PremiumOrderStatus(2);
  public static final PremiumOrderStatus FAILED = new PremiumOrderStatus(3);
  public static final PremiumOrderStatus CANCELLATION_PENDING = new PremiumOrderStatus(4);
  public static final PremiumOrderStatus CANCELED = new PremiumOrderStatus(5);
