...
public class NotesMetadataList implements TBase {
  ...
  public NotesMetadataList(NotesMetadataList other) {
    ...
    if (other.isSetNotes()) {
      ...
      for (Enumeration other_enum = other.notes.elements(); other_enum.hasMoreElements(); ) {
        NoteMetadata other_element = (NoteMetadata)other_enum.nextElement();
        __this__notes.addElement(new NoteMetadata(other_element));
      }
  ...
  public NotesMetadataList clone() {
    return new NotesMetadataList(this);
  }
  ...
  public int compareTo(Object otherObject) {
    ...
    NotesMetadataList other = (NotesMetadataList)otherObject;    int lastComparison = 0;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.notes = new Vector(_list64.size);
              for (int _i65 = 0; _i65 < _list64.size; ++_i65)
              {
                NoteMetadata _elem66;
                _elem66 = new NoteMetadata();
                _elem66.read(iprot);
                this.notes.addElement(_elem66);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.stoppedWords = new Vector(_list67.size);
              for (int _i68 = 0; _i68 < _list67.size; ++_i68)
              {
                String _elem69;
                _elem69 = iprot.readString();
                this.stoppedWords.addElement(_elem69);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.searchedWords = new Vector(_list70.size);
              for (int _i71 = 0; _i71 < _list70.size; ++_i71)
              {
                String _elem72;
                _elem72 = iprot.readString();
                this.searchedWords.addElement(_elem72);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.notes != null) {
      oprot.writeFieldBegin(NOTES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter73_enum = this.notes.elements(); _iter73_enum.hasMoreElements(); )         {
          NoteMetadata _iter73 = (NoteMetadata)_iter73_enum.nextElement();
          _iter73.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.stoppedWords != null) {
      if (isSetStoppedWords()) {
        oprot.writeFieldBegin(STOPPED_WORDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter74_enum = this.stoppedWords.elements(); _iter74_enum.hasMoreElements(); )           {
    ...
    if (this.searchedWords != null) {
      if (isSetSearchedWords()) {
        oprot.writeFieldBegin(SEARCHED_WORDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter75_enum = this.searchedWords.elements(); _iter75_enum.hasMoreElements(); )           {
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("NotesMetadataList(");
    boolean first = true;
