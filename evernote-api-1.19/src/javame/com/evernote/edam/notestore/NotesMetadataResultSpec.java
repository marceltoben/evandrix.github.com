...
public class NotesMetadataResultSpec implements TBase {
  ...
  public NotesMetadataResultSpec clone() {
    return new NotesMetadataResultSpec(this);
  }
  ...
  public int compareTo(Object otherObject) {
    ...
    NotesMetadataResultSpec other = (NotesMetadataResultSpec)otherObject;    int lastComparison = 0;

    lastComparison = TBaseHelper.compareTo(isSetIncludeTitle(), other.isSetIncludeTitle());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeTitle()) {
      lastComparison = TBaseHelper.compareTo(this.includeTitle, other.includeTitle);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeContentLength(), other.isSetIncludeContentLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeContentLength()) {
      lastComparison = TBaseHelper.compareTo(this.includeContentLength, other.includeContentLength);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeCreated(), other.isSetIncludeCreated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeCreated()) {
      lastComparison = TBaseHelper.compareTo(this.includeCreated, other.includeCreated);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeUpdated(), other.isSetIncludeUpdated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeUpdated()) {
      lastComparison = TBaseHelper.compareTo(this.includeUpdated, other.includeUpdated);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeUpdateSequenceNum(), other.isSetIncludeUpdateSequenceNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeUpdateSequenceNum()) {
      lastComparison = TBaseHelper.compareTo(this.includeUpdateSequenceNum, other.includeUpdateSequenceNum);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeNotebookGuid(), other.isSetIncludeNotebookGuid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeNotebookGuid()) {
      lastComparison = TBaseHelper.compareTo(this.includeNotebookGuid, other.includeNotebookGuid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeTagGuids(), other.isSetIncludeTagGuids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeTagGuids()) {
      lastComparison = TBaseHelper.compareTo(this.includeTagGuids, other.includeTagGuids);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeAttributes(), other.isSetIncludeAttributes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeAttributes()) {
      lastComparison = TBaseHelper.compareTo(this.includeAttributes, other.includeAttributes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeLargestResourceMime(), other.isSetIncludeLargestResourceMime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeLargestResourceMime()) {
      lastComparison = TBaseHelper.compareTo(this.includeLargestResourceMime, other.includeLargestResourceMime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetIncludeLargestResourceSize(), other.isSetIncludeLargestResourceSize());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeLargestResourceSize()) {
      lastComparison = TBaseHelper.compareTo(this.includeLargestResourceSize, other.includeLargestResourceSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("NotesMetadataResultSpec(");
    boolean first = true;
