 ...
 */
public class EDAMUserException extends Exception implements TBase {
  ...
  public EDAMUserException clone() {
    return new EDAMUserException(this);
  }
  ...
  public int compareTo(Object otherObject) {
    ...
    EDAMUserException other = (EDAMUserException)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetParameter(), other.isSetParameter());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParameter()) {
      lastComparison = TBaseHelper.compareTo(this.parameter, other.parameter);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("EDAMUserException(");
    boolean first = true;
