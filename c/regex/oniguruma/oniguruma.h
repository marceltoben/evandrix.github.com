...
#define ONIG_OPTION_IGNORECASE           0x0001
#define ONIG_OPTION_EXTEND               0x0002
#define ONIG_OPTION_MULTILINE            0x0004
#define ONIG_OPTION_SINGLELINE           0x0008
#define ONIG_OPTION_FIND_LONGEST         0x0010
#define ONIG_OPTION_FIND_NOT_EMPTY       0x0020
#define ONIG_OPTION_NEGATE_SINGLELINE    0x0040
#define ONIG_OPTION_DONT_CAPTURE_GROUP   0x0100 /* escape RE_OPTION_ONCE */
#define ONIG_OPTION_CAPTURE_GROUP        0x0200
/* options (search time) */
#define ONIG_OPTION_NOTBOL               0x0400
#define ONIG_OPTION_NOTEOL               0x0800
#define ONIG_OPTION_POSIX_REGION         0x1000
