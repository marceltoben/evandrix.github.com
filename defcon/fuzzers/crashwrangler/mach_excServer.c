/*
 * IDENTIFICATION:
 * stub generated Sun Aug 14 00:56:53 2011
...
mig_internal novalue _Xtransfer_ports
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP);
...
#if ( __MigTypeCheck || __NDR_convert__ )
#if __MIG_check__Request__mach_exc_subsystem__
#if !defined(__MIG_check__Request__transfer_ports_t__defined)
#define __MIG_check__Request__transfer_ports_t__defined

mig_internal kern_return_t __MIG_check__Request__transfer_ports_t(__attribute__((__unused__)) __Request__transfer_ports_t *In0P)
{

	typedef __Request__transfer_ports_t __Request;
#if	__MigTypeCheck
	if ((In0P->Head.msgh_bits & MACH_MSGH_BITS_COMPLEX) ||
...
#endif /* !defined(__MIG_check__Request__transfer_ports_t__defined) */
#endif /* __MIG_check__Request__mach_exc_subsystem__ */
#endif /* ( __MigTypeCheck || __NDR_convert__ ) */
...
#pragma pack()
#endif
	typedef __Request__transfer_ports_t __Request;
	typedef __Reply__transfer_ports_t Reply;
	...
	Request *In0P = (Request *) InHeadP;
	Reply *OutP = (Reply *) OutHeadP;
#ifdef	__MIG_check__Request__transfer_ports_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Request__transfer_ports_t__defined */

#if	UseStaticTemplates
	const static mach_msg_port_descriptor_t exception_portTemplate = {
		/* name = */		MACH_PORT_NULL,
		/* pad1 = */		0,
		/* pad2 = */		0,
		/* disp = */		19,
...
#if	UseStaticTemplates
	const static mach_msg_port_descriptor_t orig_bootstrap_portTemplate = {
		/* name = */		MACH_PORT_NULL,
		/* pad1 = */		0,
		/* pad2 = */		0,
		/* disp = */		19,
	...
	kern_return_t RetCode;
	__DeclareRcvRpc(2408, "transfer_ports")
	__BeforeRcvRpc(2408, "transfer_ports")

#if	defined(__MIG_check__Request__transfer_ports_t__defined)
	check_result = __MIG_check__Request__transfer_ports_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__transfer_ports_t__defined) */

#if	UseStaticTemplates
	OutP->exception_port = exception_portTemplate;
#else	/* UseStaticTemplates */
	OutP->exception_port.disposition = 19;
	OutP->exception_port.type = MACH_MSG_PORT_DESCRIPTOR;
#endif	/* UseStaticTemplates */


#if	UseStaticTemplates
	OutP->orig_bootstrap_port = orig_bootstrap_portTemplate;
#else	/* UseStaticTemplates */
	OutP->orig_bootstrap_port.disposition = 19;
	OutP->orig_bootstrap_port.type = MACH_MSG_PORT_DESCRIPTOR;
#endif	/* UseStaticTemplates */


	RetCode = catch_transfer_ports(In0P->Head.msgh_request_port, &OutP->exception_port.name, &OutP->orig_bootstrap_port.name);
	...
	__AfterRcvRpc(2408, "transfer_ports")
}
...
const struct catch_mach_exc_subsystem catch_mach_exc_subsystem = {
	...
	(vm_address_t)0,
	{
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xtransfer_ports, 3, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__transfer_ports_t)},
	}
};
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 2408) || (InHeadP->msgh_id < 2407) ||
	    ((routine = catch_mach_exc_subsystem.routine[InHeadP->msgh_id - 2407].stub_routine) == 0)) {
