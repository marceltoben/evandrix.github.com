AR = '/opt/local/x86_64-apple-darwin11.0.0/bin/ar'
ARFLAGS = 'rcs'
CCFLAGS = ['-g']
...
LIBDIR = '/Users/lwy08/.node_libraries'
LIBPATH_NODE = '/opt/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/lwy08/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/opt/local'
RANLIB = '/opt/local/x86_64-apple-darwin11.0.0/bin/ranlib'
RPATH_ST = '-Wl,-rpath,%s'
SHLIB_MARKER = ''
SONAME_ST = ''
