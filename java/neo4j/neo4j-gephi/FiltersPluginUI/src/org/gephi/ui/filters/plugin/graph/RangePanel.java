    ...
    public void setup(final RangeFilter rangeFilter) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final Range<Number> range = (Range<Number>) rangeFilter.getRangeProperty().getValue();
                    ...
                    public void propertyChange(PropertyChangeEvent evt) {
                        try {
                            if (evt.getPropertyName().equals(JRangeSliderPanel.LOWER_BOUND)) {
                                final Range<Number> newRange = new Range<Number>(r.getRange().getLowerBound(), r.getRange().getUpperBound());
