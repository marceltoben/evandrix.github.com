...
public class PartitionCountBuilder implements CategoryBuilder {
    ...
    public static class PartitionCountFilter implements Filter, RangeFilter {
        ...
        private Range<Integer> range = new Range<Integer>(0, 0);
        //States
        ...
        private void refreshRange() {
            ...
            if (min > lowerBound || max < lowerBound || lowerBound.equals(upperBound)) {
                lowerBound = min;
            }
            if (min > upperBound || max < upperBound || lowerBound.equals(upperBound)) {
                upperBound = max;
            }
