...
public class TypeHelperTest {
    ...
    @Test
    public void testParsingFromString() throws NotParsableException {
        TypeHelper.parseFromString("123",  Long.class);
        TypeHelper.parseFromString("1.3",  Double.class);
        TypeHelper.parseFromString("true", Boolean.class);
        TypeHelper.parseFromString("a",    Character.class);
        TypeHelper.parseFromString("asdf", String.class);

        TypeHelper.parseFromString("[abc, def]",    String[].class);
        TypeHelper.parseFromString("[123, 456]",    Long[].class);
        TypeHelper.parseFromString("[1.2, 3.4]",    Double[].class);
        TypeHelper.parseFromString("[true, false]", Boolean[].class);
        TypeHelper.parseFromString("[a, b, c, d ]", Character[].class);
    }
}